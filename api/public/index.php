...
use Tuupola\Middleware\CorsMiddleware; // 🟢 NEU: CORS Middleware
...
/**
 * 🔥 CORS MIDDLEWARE
 * erlaubt Aufrufe per fetch() aus dem Browser (Content-Type: application/json, Authorization, usw.)
 */
...
// Preflight-OPTIONS für alle Routen erlauben
